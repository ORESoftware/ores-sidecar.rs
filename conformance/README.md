...
`contracts/` is the authority for API and data-shape semantics in `ORESoftware/ores-sidecar.rs`. `conformance/` is the shared behavioral corpus that runtime implementations, adapters, and compatibility layers must consume.
